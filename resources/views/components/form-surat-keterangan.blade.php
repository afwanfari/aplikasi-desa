    ...
    <div class="card-body">
        <form action="{{ route('administrasi.pengajuan.pindah-keluar') }}" method="post" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <div class="input-group has-validation">
                    <input type="file" class="form-control rounded-pill @error('ktp') is-invalid @enderror" name="ktp"
                        accept=".pdf" id="ktp">
            ...
            <div class="mb-3">
                ...
                <div class="input-group has-validation">
                    <input type="file" class="form-control rounded-pill @error('kartu_keluarga') is-invalid @enderror"
            ...
            <div class="mb-3">
                ...
                <div class="input-group has-validation">
                    <input type="file" class="form-control rounded-pill @error('form_pengajuan') is-invalid @enderror"
