                                    ...
                                    @foreach ($administrasi->syarats as $syarat)
                                        <div class="col-sm-6 col-md-3">
                                            <div class="card rounded-4">
                                                <a href="{{ pathinfo($syarat->berkas, PATHINFO_EXTENSION) == 'pdf' ? route('admin.administrasi.detail', $syarat->id) : (pathinfo($syarat->berkas, PATHINFO_EXTENSION) == 'xlsx' || pathinfo($syarat->berkas, PATHINFO_EXTENSION) == 'xls' ? route('admin.administrasi.detail', $syarat->id) : '#') }}"
