        ...
        <div class="container py-5">
            ...
            <div class="row">
                <div class="col-md">
                    ...
                    @elseif (request()->jenis_pengajuan === 'skck')
                    <x-form-skck />
                    @elseif (request()->jenis_pengajuan === 'surat_kehilangan')
                    <x-form-surat-kehilangan />
                    @elseif (request()->jenis_pengajuan === 'surat_keterangan')
                    <x-form-surat-keterangan />
                    @elseif (request()->jenis_pengajuan === 'surat_menikah')
                    <x-form-surat-menikah />
                    @endif
                </div>
            </div>
        </div>
