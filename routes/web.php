...
Route::controller(AdministrasiController::class)->middleware('auth')->group(function () {
    ...
    Route::get('/administrasi/search', [AdministrasiController::class, 'search'])->name('administrasi.cari');
    ...
    Route::post('/pengajuan/skck', 'skck')
        ->name('administrasi.pengajuan.skck');

    Route::post('/pengajuan/surat-kehilangan', 'SuratPengantarKehilangan')
        ->name('administrasi.pengajuan.surat-kehilangan');

    Route::post('/pengajuan/surat-keterangan', 'SuratKeterangan')
        ->name('administrasi.pengajuan.surat-keterangan');

    Route::post('/pengajuan/surat-menikah', 'SuratKeteranganMenikah')
        ->name('administrasi.pengajuan.surat-menikah');
});
