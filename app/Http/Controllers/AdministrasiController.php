...
class AdministrasiController extends Controller
{
    ...
    {
        $query = request()->jenis_pengajuan;

       $pencarian = Administrasi::where('jenis_pengajuan', $query)
           ->orderBy('id', 'ASC')
           ->get();
    }
    ...
    public function skck(Request $request)
    {
        ...
        // Membuat jalur folder
        $path = auth()->user()->username . '/' . $ticket . 'skck/';
    ...
    public function SuratPengantarKehilangan(Request $request)
    {
        // Validasi
        $validated = $request->validate([
            'ktp' => 'nullable|file|mimes:pdf|max:2048',
    ...
    public function SuratKeteranganMenikah(Request $request)
    {
        // Validasi
        $validated = $request->validate([
            'ktp' => 'nullable|file|mimes:pdf|max:2048',
